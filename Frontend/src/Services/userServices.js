...
const userService = {
  ...
  forgetPasswordSendOtp: (data) =>
    axiosClient.post("/users/forget/password/send/otp", data),

  // Forget password Verify OTP
  forgetPasswordVerifyOtp: (data) =>
    axiosClient.post("/users/forget/password/verify/otp", data),

  // Reset password
  resetPassword: (data) =>
    axiosClient.post("/users/forget/password/reset", data),
  ...
  // Get all Enquiry
  allEnquiry: (currentPage, size) =>
    axiosClient.get(`/users/all/enquiry?page=${currentPage}&size=${size}`, {
      headers: {
  ...
  // update User
  updateUser: (data) =>
    axiosClient.patch("users/profile/update", data, {
      headers: {
        Authorization: `Bearer ${AuthService.getAccessToken()}`,
      },
    }),
  ...
  createGeneralDetail: (data) =>
    axiosClient.post("/users/create/company/profile/general/detail", data, {
      headers: {
  ...
  createCompanyInfo: (data) =>
    axiosClient.post("/users/create/company/profile/contact/info", data, {
      headers: {
        Authorization: `Bearer ${AuthService.getAccessToken()}`,
      },
    }),
  ...
  createCertificate: (data) =>
    axiosClient.post("/users/create/company/profile/certification", data, {
      headers: {
        "Content-Type": "multipart/form-data",
        Authorization: `Bearer ${AuthService.getAccessToken()}`,
      },
  ...
  createDocument: (data) =>
    axiosClient.post("/users/create/company/document", data, {
      headers: {
        "Content-Type": "multipart/form-data",
        Authorization: `Bearer ${AuthService.getAccessToken()}`,
      },
  ...
  // create document / update
  createCompanyRegistration: (data) =>
    axiosClient.post("/users/create/company/profile/registration", data, {
      headers: {
        Authorization: `Bearer ${AuthService.getAccessToken()}`,
      },
    }),
  ...
  createOfficeLocation: (data) =>
    axiosClient.post("/users/create/company/office/location", data, {
      headers: {
        Authorization: `Bearer ${AuthService.getAccessToken()}`,
      },
    }),
  ...
  showCompanyData: (data) =>
    axiosClient.get(`/users/company/profile?type=${data}`, {
      headers: {
        Authorization: `Bearer ${AuthService.getAccessToken()}`,
      },
    }),
  ...
  // get subscription
  getAllSubscription: () =>
    axiosClient.get("/users/subscription/plans", {
      headers: {
        Authorization: `Bearer ${AuthService.getAccessToken()}`,
      },
    }),
  ...
  createSubscription: (data) =>
    axiosClient.post("/users/create/subscription", data, {
      headers: {
        Authorization: `Bearer ${AuthService.getAccessToken()}`,
      },
    }),
